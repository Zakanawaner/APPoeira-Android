package com.onethousandprojects.appoeira.serverStuff.onlineList;

public class ServerLocationOnlineResponse {
    private Integer id;
    private String name;
    private String date;
    ...
    public ServerLocationOnlineResponse(Integer id, String name, String date, String picUrl,

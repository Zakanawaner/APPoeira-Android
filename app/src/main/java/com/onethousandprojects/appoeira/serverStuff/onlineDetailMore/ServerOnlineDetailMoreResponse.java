...
public class ServerOnlineDetailMoreResponse {
    private String onlineSchool;
    ...
    public ServerOnlineDetailMoreResponse(String onlineSchool, Integer userId, String userApelhido, String userPicUrl,
    ...
    public String getOnlineSchool() {
        return onlineSchool;
    }

    public void setOnlineSchool(String onlineSchool) {
        this.onlineSchool = onlineSchool;
    }

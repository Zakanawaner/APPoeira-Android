...
public class ServerRodaDetailResponse {
    ...
    public ServerRodaDetailResponse(String error, Integer id, String name, String picUrl, String description, String phone,

...
public class ServerGroupDetailMoreResponse {
    ...
    public ServerGroupDetailMoreResponse(String groupSchool, Integer userId, String userApelhido, String userPicUrl,

...
public class RodaDetailMoreServer {
    ...
    public void getRodaDetailMore(RodaDetailMoreActivity RodaDetailMoreActivity, Integer groupId) {
        ClientRodaDetailMoreRequest clientRodaDetailMoreRequest = new ClientRodaDetailMoreRequest(groupId);
    ...
    public void serverRodaCommentsResponse(RodaDetailMoreActivity RodaDetailMoreActivity, Integer groupId) {
        ClientCommentsRequest clientRodaCommentsRequest = new ClientCommentsRequest(groupId);
        Call<List<ServerCommentsResponse>> call1 = Server.post_group_comments(clientRodaCommentsRequest);
    ...
    public void postComment(RodaDetailMoreActivity RodaDetailMoreActivity, Integer group_id, String comment) {
        ClientNewCommentRequest clientRodaNewCommentRequest = new ClientNewCommentRequest(group_id, SharedPreferencesManager.getIntegerValue(Constants.ID), comment);
    ...
    public void joinRoda(RodaDetailMoreActivity RodaDetailMoreActivity, Integer group_id, Integer roleId) {
        ClientJoinRequest clientRodaJoinRequest = new ClientJoinRequest(group_id, SharedPreferencesManager.getIntegerValue(Constants.ID), roleId);
        Call<ServerJoinResponse> call = Server.post_join_group(clientRodaJoinRequest);
    ...
    public void sendRating(RodaDetailMoreActivity RodaDetailMoreActivity, Integer group_id, Integer stars) {
        ClientRatedByUserRequest clientRodaRatedByUserRequest = new ClientRatedByUserRequest(SharedPreferencesManager.getIntegerValue(Constants.ID), group_id, stars);
        Call<ServeRatedByUserResponse> call = Server.post_user_rated_group(clientRodaRatedByUserRequest);

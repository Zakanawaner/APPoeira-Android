...
public class BeenHereRatingOnline extends DialogFragment {
        ...
        btnBeenHere.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!beenHere) {
                    ...
                    onlineDetailMoreActivity.onlineDetailMoreServer.sendRating(onlineDetailMoreActivity, onlineDetailMoreActivity.fromOnlineDetailActivity.getInt("onlineId"), stars);
                }
            }
        });
        return view;

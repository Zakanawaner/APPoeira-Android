...
import com.onethousandprojects.appoeira.searchView.fragment.VerifyEmailFragment;
        ...
        if (CommonMethods.AmILogged()) {
            ...
            bv.setListener(new CommonMethods.NewsVariable.ChangeListener() {
                ...
                public void onChange() {
                    if (bv.gotNews) {
                        topNavigationView.getMenu().getItem(2).setIcon(ContextCompat.getDrawable(SearchActivity.this, R.drawable.ic_circle));
                    }
                }
            });
        }
            ...
            public void onResponse(@NonNull Call<ServerSendEmailResponse> call, @NonNull Response<ServerSendEmailResponse> response) {
                if (response.isSuccessful()){
                    ...
                    if (serverSendEmailResponse.isOk()) {
                        Toast.makeText(SearchActivity.this,R.string.checkYourEmail, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(SearchActivity.this,R.string.failed, Toast.LENGTH_SHORT).show();
                }

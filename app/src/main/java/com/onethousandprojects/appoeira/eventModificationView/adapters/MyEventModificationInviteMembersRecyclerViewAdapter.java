...
public class MyEventModificationInviteMembersRecyclerViewAdapter extends RecyclerView.Adapter<MyEventModificationInviteMembersRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (((EventModificationActivity) ctx).checkMembers(holder.mItem.getId(), false)){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View view, OnEventModificationInviteMembersListener onEventModificationInviteMembersListener) {
            super(view);
            mView = view;
            ...
            this.onEventModificationInviteMembersListener = onEventModificationInviteMembersListener;
    ...
    public interface OnEventModificationInviteMembersListener {
        void OnEventInviteMemberClick(int position);
    }

...
public class VerifyEmailFragment extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        OnlineListActivity onlineListActivity = (OnlineListActivity) requireActivity();
        ...
        ivClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onlineListActivity.killVerifyFragment();
            }
        });
        btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onlineListActivity.onlineListServer.sendVerificationEmail(onlineListActivity, 1, SharedPreferencesManager.getIntegerValue(Constants.ID), 0);
            }
        });

    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ivClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((OnlineModificationActivity) requireActivity()).killAvatarFragment();
            }
        });
        ...
        btnUploadPic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (((OnlineModificationActivity) requireActivity()).imageBitmap != null) {
                    ((OnlineModificationActivity) requireActivity()).killAvatarFragment();
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == Constants.CAMERA_REQUEST_CODE_INTENT) {
                ...
                assert extras != null;
                ((OnlineModificationActivity) requireActivity()).imageBitmap = (Bitmap) extras.get("data");
                assert activity != null;
                activity.ivAvatar.setImageBitmap(((OnlineModificationActivity) requireActivity()).imageBitmap);
            }
            if (requestCode == Constants.GALLERY_REQUEST_CODE_INTENT) {
                ...
                ((OnlineModificationActivity) requireActivity()).imageBitmap = BitmapFactory.decodeStream(inputStream);
                assert activity != null;
                activity.ivAvatar.setImageBitmap(((OnlineModificationActivity) requireActivity()).imageBitmap);
            }
        }

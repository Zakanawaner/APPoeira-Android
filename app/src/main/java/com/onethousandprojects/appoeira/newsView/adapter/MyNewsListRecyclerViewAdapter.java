package com.onethousandprojects.appoeira.newsView.adapter;
...
public class MyNewsListRecyclerViewAdapter extends RecyclerView.Adapter<MyNewsListRecyclerViewAdapter.ViewHolder> {
    ...
    public MyNewsListRecyclerViewAdapter(Context context, List<EventContent> items, OnEventListener onEventListener) {
        mValues = items;
        ctx = context;

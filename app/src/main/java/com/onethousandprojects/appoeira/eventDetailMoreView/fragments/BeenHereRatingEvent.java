...
public class BeenHereRatingEvent extends DialogFragment {
        ...
        btnBeenHere.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!beenHere) {
                    ...
                    eventDetailMoreActivity.eventDetailMoreServer.sendRating(eventDetailMoreActivity, eventDetailMoreActivity.fromEventDetailActivity.getInt("eventId"), stars);
                }
            }
        });
        return view;

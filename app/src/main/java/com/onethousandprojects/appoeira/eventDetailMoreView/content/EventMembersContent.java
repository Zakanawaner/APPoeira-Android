package com.onethousandprojects.appoeira.eventDetailMoreView.content;

public class EventMembersContent {
    ...
    public EventMembersContent(String groupSchool, Integer userId, String userApelhido, String userPicUrl,
